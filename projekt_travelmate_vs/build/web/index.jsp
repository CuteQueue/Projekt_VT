                ...
                <tr>
                    <td>
                        <form action="home.html">
                            <strong>Email:</strong>
                            <input type="text" size="40" maxlength="50" name="login1" id="login_mail"><br>
                            <strong>Password:</strong>
                            <input type="text" size="40" maxlength="15" name="login2" id="login_pw">
                            <button onClick="postHttpRequest('LoginServlet')">Post</button>
                        </form>
                    </td>
                </tr>
            </tbody>
