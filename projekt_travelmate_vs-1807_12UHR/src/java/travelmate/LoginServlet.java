    ...
    throws ServletException, IOException, RemoteException, NotBoundException {
        ...
        String validated = "false";
            ...
            out.println("2");
                ...
                out.print(res.encodeURL ("LoginServlet"));
            ...
            if(validated.equals("true")){
                ...
                out.println("<script src='http://cdnjs.cloudflare.com/ajax/libs/underscore.js/1.6.0/underscore-min.js'></script>"); 
                out.println("<script src='http://cdnjs.cloudflare.com/ajax/libs/jquery/2.1.1/jquery.min.js'></script>"); 
                out.println("<script src='http://cdnjs.cloudflare.com/ajax/libs/backbone.js/1.1.2/backbone-min.js'></script>"); 
                out.println("<script src='RestClientUsers.js'></script>"); 
                out.println("<meta http-equiv=\"refresh\" content=\"text/html; charset=utf-8;URL=\"http://localhost:8080/projekt_travelmate_vs/LoginServlet\"></head>"); 
