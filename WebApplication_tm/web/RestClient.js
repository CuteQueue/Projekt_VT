...
// Model for Users entity
    models.Users = Backbone.Model.extend({
        urlRoot: "http://localhost:8080/WebApplication_tm/api/users/",
        idAttribute: 'id',
        defaults: {
            lastName: "",
            password: "",
        ...
        sync: function (method, model, options) {
            ...
            if (method === 'create') {
                options.url = 'http://localhost:8080/WebApplication_tm/api/users/';
            }
    ...
    models.UsersCollection = Backbone.Collection.extend({
        model: models.Users,
        url: "http://localhost:8080/WebApplication_tm/api/users/",
        sync: function (method, model, options) {
            options || (options = {});
            var errorHandler = {
                error: function (jqXHR, textStatus, errorThrown) {
